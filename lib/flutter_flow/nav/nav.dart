...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'open1',
          path: '/open1',
          builder: (context, params) => const Open1Widget(),
        ),
        FFRoute(
          name: 'open2',
          path: '/open2',
          builder: (context, params) => const Open2Widget(),
        ),
        FFRoute(
          name: 'open3',
          path: '/open3',
          builder: (context, params) => const Open3Widget(),
        ),
        FFRoute(
          name: 'main',
          path: '/main',
        ...
        FFRoute(
          name: 'lab_results',
          path: '/labResults',
          builder: (context, params) => const LabResultsWidget(),
        ),
        FFRoute(
          name: 'homepage',
          path: '/homepage',
