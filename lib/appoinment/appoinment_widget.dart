                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Find and schedule your next health visit',
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=500&h=500',
                                          width: 168.0,
                                          height: 100.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1518733057094-95b53143d2a7?w=500&h=500',
                                          width: 168.0,
                                          height: 100.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(30.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1673865641073-4479f93a7776?w=500&h=500',
                                          width: 60.0,
                                          height: 60.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(30.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1550831106-0994fe8abcfe?w=500&h=500',
                                          width: 60.0,
                                          height: 60.0,
                                          fit: BoxFit.cover,
                                        ),
